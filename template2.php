...
//
// 05/24/26
// 1. $DEFAULT_PATH = "/booths"
// 2. $NEW_PATH = "To be assigned with the uploads direcotry path. Example: '/tmp/php/uploads/Tony_Shen_20260523211251'"
// 3. $NEW_TITLE = "To be assigned"; 
// 4. $NEW_FILENAME = "To be assigned"; 
//
$DEFAULT_PATH = "/booths";
$NEW_PATH = "/tmp/php/uploads/Tony_Shen_20260523211251";
$DEFAULT_TITLE = "Pearland Chinese New Year"; 
$NEW_TITLE = "";
$DEFAULT_FILENAME = "pearland-chinese-new-year.htm";
$NEW_FILENAME = ""; 
...
// text content
$entextfilepath = $_SERVER['DOCUMENT_ROOT'] . $NEW_PATH . "/contents/en/pearland-chinese-new-year.htm";
$entext = file_get_contents($entextfilepath);

$zhtextfilepath = $_SERVER['DOCUMENT_ROOT'] . $NEW_PATH . "/contents/zh/pearland-chinese-new-year.htm";
$zhtext = file_get_contents($zhtextfilepath);

$estextfilepath = $_SERVER['DOCUMENT_ROOT'] . $NEW_PATH . "/contents/es/pearland-chinese-new-year.htm";
$estext = file_get_contents($estextfilepath);

// form
$formfilepath = $_SERVER['DOCUMENT_ROOT'] . $DEFAULT_PATH . "/forms/contact-bswp.htm";
$form = file_get_contents($formfilepath);

// gallery
$g1filepath = $_SERVER['DOCUMENT_ROOT'] . $NEW_PATH . "/images/pearland-chinese-new-year.htm";
$g1 = file_get_contents($g1filepath);

// videos
$v1filepath = $_SERVER['DOCUMENT_ROOT'] . $NEW_PATH . "/videos/pearland-chinese-new-year.htm";
$v1 = file_get_contents($v1filepath);

// links
$l1filepath = $_SERVER['DOCUMENT_ROOT'] . $NEW_PATH . "/links/pearland-chinese-new-year.htm";
